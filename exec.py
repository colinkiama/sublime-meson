...
class ExecCommand(sublime_plugin.WindowCommand, ProcessListener):
    ...
    def run(
        ...
        if self.output_view is None:
            ...
            self.output_view = self.window.create_output_panel(self.output_panel_name)
        ...
        self.window.create_output_panel(self.output_panel_name)
        ...
        if show_panel_on_build:
            self.window.run_command("show_panel", 
            	{"panel": "output." + self.output_panel_name
            })
    ...
    def hide_annotations(self):
        for window in sublime.windows():
            for file, errs in self.errs_by_file.items():
                ...
                if view:
                    view.erase_regions(self.output_panel_name)
                    view.hide_popup()
